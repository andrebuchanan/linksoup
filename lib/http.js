...
var app = express().
  ...
  use(express.session({ secret: hashSecret, key: "arb.sess", cookie: { path: "/", httpOnly: true, maxAge: null }})).
...
var soUri = "https://api.mongolab.com/api/1/databases/arb/collections/events";
var serviceOptions = {
  method: "GET",
